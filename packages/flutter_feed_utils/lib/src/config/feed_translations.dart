...
/// Class that holds all the translations for the feed component view and
///  the corresponding userstory
class FeedTranslations {
  /// FeedTranslations constructor where everything is required use this
  ...
  const FeedTranslations({
    ...
    required this.feedSelectionDescription,
  ...
  /// Default translations for the feed component view
  const FeedTranslations.empty({
    ...
    this.feedSelectionDescription = "Choose a category",
    ...
    this.yes = "Yes",
    this.no = "No",
    this.feedScreenTitle = "iconinstagram",
  ...
  final String feedSelectionDescription;
  ...
  FeedTranslations copyWith({
    ...
    String? feedSelectionDescription,
    String? searchHint,
    String? postOverview,
    String? postIn,
    String? postCreation,
    ...
    String? contentErrorText,
      ...
      FeedTranslations(
        ...
        feedSelectionDescription:
            feedSelectionDescription ?? this.feedSelectionDescription,
        ...
        yes: yes ?? this.yes,
        no: no ?? this.no,
        feedScreenTitle: feedScreenTitle ?? this.feedScreenTitle,
