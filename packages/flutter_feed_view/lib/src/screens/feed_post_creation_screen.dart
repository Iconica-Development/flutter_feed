...
import "package:flutter_feed_view/src/widgets/post_creation_textfield.dart";
import "package:flutter_image_picker/flutter_image_picker.dart";

class FeedPostCreationScreen extends StatefulWidget {
  const FeedPostCreationScreen({
  ...
  /// The options for the feed
  final FeedOptions options;

  /// Nullable callback for routing to the post overview
  final void Function(FeedPost)? onPostOverview;
  final bool enablePostOverviewScreen;

  @override
  State<FeedPostCreationScreen> createState() => _FeedPostCreationScreenState();
}

class _FeedPostCreationScreenState extends State<FeedPostCreationScreen> {
