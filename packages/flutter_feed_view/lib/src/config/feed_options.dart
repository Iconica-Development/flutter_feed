...
import "package:flutter_feed_view/src/config/feed_paddings.dart";
import "package:flutter_feed_view/src/config/feed_theme.dart";
import "package:flutter_feed_view/src/config/feed_translations.dart";
import "package:flutter_image_picker/flutter_image_picker.dart";
import "package:intl/intl.dart";

class FeedOptions {
  const FeedOptions({
    this.theme = const FeedTheme(),
    this.translations = const FeedTranslations.empty(),
    this.paddings = const FeedPaddingOptions(),
  ...
  /// Theming options for the feed
  final FeedTheme theme;
  ...
  /// The height of a post in the feed
  final double? feedPostHeight;

  /// Class that contains all the translations used in the feed
  final FeedTranslations translations;

  /// Class that contains all the paddings used in the feed
  final FeedPaddingOptions paddings;
  ...
  final String Function(FeedPosterUserModel?)? nameBuilder;
  ...
  final Widget Function({required FeedPost post})? itemInfoBuilder;
  ...
  /// on the feed category selection screen
  ...
  /// on the feed post overview screen
  final Widget Function(
    BuildContext context,
    Function() onPressed,
    String text,
